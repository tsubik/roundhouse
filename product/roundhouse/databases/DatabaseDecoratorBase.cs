namespace roundhouse.databases
{
    ...
    public abstract class DatabaseDecoratorBase : Database
    {
        ...
        {
            return database.create_object_script(object_type, object_name);
        }

        public string get_object_definition(string object_name)
        {
            return database.get_object_definition(object_name);
        }

        public System.Collections.Generic.List<string> get_dependent_schemabound_views(string object_name)
        {
            return database.get_dependent_schemabound_views(object_name);
        }
    }
}